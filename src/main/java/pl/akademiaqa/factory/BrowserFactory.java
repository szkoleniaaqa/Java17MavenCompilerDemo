...
public class BrowserFactory {
    ...
    public Browser getBrowser() {
        var browserName = Properties.getProperty("app.browser").toLowerCase();

        var launchOptions = new BrowserType.LaunchOptions()
                .setHeadless(Boolean.parseBoolean(Properties.getProperty("app.browser.headless")))
                .setSlowMo(Integer.parseInt(Properties.getProperty("app.browser.slow.mo")));
